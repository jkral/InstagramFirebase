...
class UserProfileHeader: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        profileImageView.anchor(top: safeAreaLayoutGuide.topAnchor, left: leftAnchor, bottom: nil, right: nil, paddingTop: 12, paddingLeft: 12, paddingBottom: 0, paddingRight: 0, width: 80, height: 80)
    ...
    fileprivate func setupUserStatsView() {
        ...
        stackView.anchor(top: safeAreaLayoutGuide.topAnchor, left:  profileImageView.rightAnchor, bottom: nil, right: rightAnchor, paddingTop: 12, paddingLeft:  12, paddingBottom: 0, paddingRight: 12, width: 0, height: 50)
    }
