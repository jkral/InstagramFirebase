...
//  InstagramFirebase
//
//  Created by Jeff Kral on 1/3/18.
...
//        tf.addTarget(self, action: #selector(handleTextInputChange), for: .editingChanged)
    ...
    override func viewDidLoad() {
        ...
        dontHaveAccountButton.anchor(top: nil, left: view.leftAnchor, bottom: view.bottomAnchor, right: view.rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: -5, paddingRight: 0, width: 0, height: 50)
